...
def get_standard_rings_data():
        return extrair_dados_sqlite(r'D:\Doutorado\ATLAS_calibration\database\sql_files\StdRings.db', 'events')
           
def get_quarter_rings_data():
        return extrair_dados_sqlite(r'D:\Doutorado\ATLAS_calibration\database\sql_files\QRings.db', 'events')

def get_relevant_data():
        return extrair_dados_sqlite(r'D:\Doutorado\ATLAS_calibration\database\sql_files\ClusterData.db', 'events')
